...
class NeuralNetworkV2 final : public CostAndGradient {
    ...
    NeuralNetworkV2(const arma::mat& layerSizes, const arma::mat& X, const arma::mat& y, double lambda,
                    bool featureScaling = false, ActivationFunction af = SIGMOID, bool verbose = true);

    void initializeParametersHe();
    void initialize_parameters_deep();
    ...
    void L_model_backward(const arma::mat& AL, arma::mat Y);
    ...
    void L_layer_model(double learning_rate = 0.0075, int num_iterations = 3000, bool debug = false );
    ...
    RetVal& calc( const arma::mat& nn_params, bool costOnly = false ) override { return mRetVal;}
