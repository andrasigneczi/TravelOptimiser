...
#define NS_DECL_NSIDOMWINDOWCOLLECTION \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) override; \
  NS_IMETHOD NamedItem(const nsAString & name, nsIDOMWindow * *_retval) override; 
...
#define NS_FORWARD_NSIDOMWINDOWCOLLECTION(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) override { return _to Item(index, _retval); } \
  NS_IMETHOD NamedItem(const nsAString & name, nsIDOMWindow * *_retval) override { return _to NamedItem(name, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWCOLLECTION(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
  NS_IMETHOD NamedItem(const nsAString & name, nsIDOMWindow * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NamedItem(name, _retval); } 
