...
#define NS_DECL_NSIPRINTSTATUSFEEDBACK \
  ...
  NS_IMETHOD SetDocShell(nsIDocShell *shell, nsIDOMWindow *window) override; \
...
#define NS_FORWARD_NSIPRINTSTATUSFEEDBACK(_to) \
  ...
  NS_IMETHOD SetDocShell(nsIDocShell *shell, nsIDOMWindow *window) override { return _to SetDocShell(shell, window); } \
...
#define NS_FORWARD_SAFE_NSIPRINTSTATUSFEEDBACK(_to) \
  ...
  NS_IMETHOD SetDocShell(nsIDocShell *shell, nsIDOMWindow *window) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDocShell(shell, window); } \
