...
#define NS_DECL_NSIEDITINGSESSION \
  ...
  NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) override; \
  NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval) override; \
  NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor * *_retval) override; \
  NS_IMETHOD SetupEditorOnWindow(nsIDOMWindow *window) override; \
  NS_IMETHOD TearDownEditorOnWindow(nsIDOMWindow *window) override; \
  NS_IMETHOD SetEditorOnControllers(nsIDOMWindow *aWindow, nsIEditor *aEditor) override; \
  NS_IMETHOD DisableJSAndPlugins(nsIDOMWindow *aWindow) override; \
  NS_IMETHOD RestoreJSAndPlugins(nsIDOMWindow *aWindow) override; \
  NS_IMETHOD DetachFromWindow(nsIDOMWindow *aWindow) override; \
  NS_IMETHOD ReattachToWindow(nsIDOMWindow *aWindow) override; \
...
#define NS_FORWARD_NSIEDITINGSESSION(_to) \
  ...
  NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) override { return _to MakeWindowEditable(window, aEditorType, doAfterUriLoad, aMakeWholeDocumentEditable, aInteractive); } \
  NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval) override { return _to WindowIsEditable(window, _retval); } \
  NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor * *_retval) override { return _to GetEditorForWindow(window, _retval); } \
  NS_IMETHOD SetupEditorOnWindow(nsIDOMWindow *window) override { return _to SetupEditorOnWindow(window); } \
  NS_IMETHOD TearDownEditorOnWindow(nsIDOMWindow *window) override { return _to TearDownEditorOnWindow(window); } \
  NS_IMETHOD SetEditorOnControllers(nsIDOMWindow *aWindow, nsIEditor *aEditor) override { return _to SetEditorOnControllers(aWindow, aEditor); } \
  NS_IMETHOD DisableJSAndPlugins(nsIDOMWindow *aWindow) override { return _to DisableJSAndPlugins(aWindow); } \
  NS_IMETHOD RestoreJSAndPlugins(nsIDOMWindow *aWindow) override { return _to RestoreJSAndPlugins(aWindow); } \
  NS_IMETHOD DetachFromWindow(nsIDOMWindow *aWindow) override { return _to DetachFromWindow(aWindow); } \
  NS_IMETHOD ReattachToWindow(nsIDOMWindow *aWindow) override { return _to ReattachToWindow(aWindow); } \
...
#define NS_FORWARD_SAFE_NSIEDITINGSESSION(_to) \
  ...
  NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MakeWindowEditable(window, aEditorType, doAfterUriLoad, aMakeWholeDocumentEditable, aInteractive); } \
  NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->WindowIsEditable(window, _retval); } \
  NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEditorForWindow(window, _retval); } \
  NS_IMETHOD SetupEditorOnWindow(nsIDOMWindow *window) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetupEditorOnWindow(window); } \
  NS_IMETHOD TearDownEditorOnWindow(nsIDOMWindow *window) override { return !_to ? NS_ERROR_NULL_POINTER : _to->TearDownEditorOnWindow(window); } \
  NS_IMETHOD SetEditorOnControllers(nsIDOMWindow *aWindow, nsIEditor *aEditor) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEditorOnControllers(aWindow, aEditor); } \
  NS_IMETHOD DisableJSAndPlugins(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DisableJSAndPlugins(aWindow); } \
  NS_IMETHOD RestoreJSAndPlugins(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RestoreJSAndPlugins(aWindow); } \
  NS_IMETHOD DetachFromWindow(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DetachFromWindow(aWindow); } \
  NS_IMETHOD ReattachToWindow(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ReattachToWindow(aWindow); } \
