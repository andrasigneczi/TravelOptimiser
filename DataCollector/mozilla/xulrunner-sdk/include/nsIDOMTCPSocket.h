...
#define NS_DECL_NSIDOMTCPSOCKET \
  NS_IMETHOD Open(const nsAString & host, uint16_t port, JS::HandleValue options, nsIDOMTCPSocket * *_retval) override; \
  NS_IMETHOD Listen(uint16_t localPort, JS::HandleValue options, uint16_t backlog, nsIDOMTCPServerSocket * *_retval) override; \
  NS_IMETHOD UpgradeToSecure(void) override; \
  NS_IMETHOD GetHost(nsAString & aHost) override; \
  NS_IMETHOD GetPort(uint16_t *aPort) override; \
  NS_IMETHOD GetSsl(bool *aSsl) override; \
  ...
  NS_IMETHOD Send(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, bool *_retval) override; \
  NS_IMETHOD GetReadyState(nsAString & aReadyState) override; \
  NS_IMETHOD GetBinaryType(nsAString & aBinaryType) override; \
  NS_IMETHOD GetOnopen(JS::MutableHandleValue aOnopen) override; \
  NS_IMETHOD SetOnopen(JS::HandleValue aOnopen) override; \
  NS_IMETHOD GetOndrain(JS::MutableHandleValue aOndrain) override; \
  NS_IMETHOD SetOndrain(JS::HandleValue aOndrain) override; \
  NS_IMETHOD GetOndata(JS::MutableHandleValue aOndata) override; \
  NS_IMETHOD SetOndata(JS::HandleValue aOndata) override; \
  NS_IMETHOD GetOnerror(JS::MutableHandleValue aOnerror) override; \
  NS_IMETHOD SetOnerror(JS::HandleValue aOnerror) override; \
  NS_IMETHOD GetOnclose(JS::MutableHandleValue aOnclose) override; \
  NS_IMETHOD SetOnclose(JS::HandleValue aOnclose) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMTCPSOCKET(_to) \
  NS_IMETHOD Open(const nsAString & host, uint16_t port, JS::HandleValue options, nsIDOMTCPSocket * *_retval) override { return _to Open(host, port, options, _retval); } \
  NS_IMETHOD Listen(uint16_t localPort, JS::HandleValue options, uint16_t backlog, nsIDOMTCPServerSocket * *_retval) override { return _to Listen(localPort, options, backlog, _retval); } \
  NS_IMETHOD UpgradeToSecure(void) override { return _to UpgradeToSecure(); } \
  ...
  NS_IMETHOD GetSsl(bool *aSsl) override { return _to GetSsl(aSsl); } \
  ...
  NS_IMETHOD Send(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, bool *_retval) override { return _to Send(data, byteOffset, byteLength, _retval); } \
  ...
  NS_IMETHOD GetOnopen(JS::MutableHandleValue aOnopen) override { return _to GetOnopen(aOnopen); } \
  NS_IMETHOD SetOnopen(JS::HandleValue aOnopen) override { return _to SetOnopen(aOnopen); } \
  NS_IMETHOD GetOndrain(JS::MutableHandleValue aOndrain) override { return _to GetOndrain(aOndrain); } \
  NS_IMETHOD SetOndrain(JS::HandleValue aOndrain) override { return _to SetOndrain(aOndrain); } \
  NS_IMETHOD GetOndata(JS::MutableHandleValue aOndata) override { return _to GetOndata(aOndata); } \
  NS_IMETHOD SetOndata(JS::HandleValue aOndata) override { return _to SetOndata(aOndata); } \
  NS_IMETHOD GetOnerror(JS::MutableHandleValue aOnerror) override { return _to GetOnerror(aOnerror); } \
  NS_IMETHOD SetOnerror(JS::HandleValue aOnerror) override { return _to SetOnerror(aOnerror); } \
  NS_IMETHOD GetOnclose(JS::MutableHandleValue aOnclose) override { return _to GetOnclose(aOnclose); } \
  NS_IMETHOD SetOnclose(JS::HandleValue aOnclose) override { return _to SetOnclose(aOnclose); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMTCPSOCKET(_to) \
  NS_IMETHOD Open(const nsAString & host, uint16_t port, JS::HandleValue options, nsIDOMTCPSocket * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(host, port, options, _retval); } \
  NS_IMETHOD Listen(uint16_t localPort, JS::HandleValue options, uint16_t backlog, nsIDOMTCPServerSocket * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Listen(localPort, options, backlog, _retval); } \
  NS_IMETHOD UpgradeToSecure(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UpgradeToSecure(); } \
  ...
  NS_IMETHOD GetSsl(bool *aSsl) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSsl(aSsl); } \
  ...
  NS_IMETHOD Send(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Send(data, byteOffset, byteLength, _retval); } \
  ...
  NS_IMETHOD GetOnopen(JS::MutableHandleValue aOnopen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnopen(aOnopen); } \
  NS_IMETHOD SetOnopen(JS::HandleValue aOnopen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnopen(aOnopen); } \
  NS_IMETHOD GetOndrain(JS::MutableHandleValue aOndrain) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOndrain(aOndrain); } \
  NS_IMETHOD SetOndrain(JS::HandleValue aOndrain) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOndrain(aOndrain); } \
  NS_IMETHOD GetOndata(JS::MutableHandleValue aOndata) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOndata(aOndata); } \
  NS_IMETHOD SetOndata(JS::HandleValue aOndata) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOndata(aOndata); } \
  NS_IMETHOD GetOnerror(JS::MutableHandleValue aOnerror) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnerror(aOnerror); } \
  NS_IMETHOD SetOnerror(JS::HandleValue aOnerror) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnerror(aOnerror); } \
  NS_IMETHOD GetOnclose(JS::MutableHandleValue aOnclose) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnclose(aOnclose); } \
  NS_IMETHOD SetOnclose(JS::HandleValue aOnclose) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnclose(aOnclose); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMTCPSocket, nsIDOMTCPSocket)
...
#define NS_ITCPSOCKETINTERNAL_IID_STR "ac2c4b69-cb79-4767-b1ce-bcf62945cd39"
...
class NS_NO_VTABLE nsITCPSocketInternal : public nsISupports {
 public: 
  ...
  /* nsIDOMTCPSocket createAcceptedParent (in nsISocketTransport transport, in DOMString binaryType, in nsIDOMWindow window); */
  NS_IMETHOD CreateAcceptedParent(nsISocketTransport *transport, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) = 0;
  ...
  NS_IMETHOD SetInBrowser(bool inBrowser) = 0;
...
#define NS_DECL_NSITCPSOCKETINTERNAL \
  NS_IMETHOD CallListenerError(const nsAString & type, const nsAString & name) override; \
  NS_IMETHOD CallListenerData(const nsAString & type, const nsAString & data) override; \
  NS_IMETHOD CallListenerArrayBuffer(const nsAString & type, JS::HandleValue data) override; \
  NS_IMETHOD CallListenerVoid(const nsAString & type) override; \
  NS_IMETHOD UpdateReadyState(const nsAString & readyState) override; \
  NS_IMETHOD UpdateBufferedAmount(uint32_t bufferedAmount, uint32_t trackingNumber) override; \
  NS_IMETHOD CreateAcceptedParent(nsISocketTransport *transport, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override; \
  NS_IMETHOD CreateAcceptedChild(nsITCPSocketChild *socketChild, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override; \
  NS_IMETHOD SetAppId(uint32_t appId) override; \
  NS_IMETHOD SetInBrowser(bool inBrowser) override; \
  NS_IMETHOD SetOnUpdateBufferedAmountHandler(JS::HandleValue handler) override; \
  NS_IMETHOD OnRecvSendFromChild(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, uint32_t trackingNumber) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITCPSOCKETINTERNAL(_to) \
  NS_IMETHOD CallListenerError(const nsAString & type, const nsAString & name) override { return _to CallListenerError(type, name); } \
  NS_IMETHOD CallListenerData(const nsAString & type, const nsAString & data) override { return _to CallListenerData(type, data); } \
  NS_IMETHOD CallListenerArrayBuffer(const nsAString & type, JS::HandleValue data) override { return _to CallListenerArrayBuffer(type, data); } \
  NS_IMETHOD CallListenerVoid(const nsAString & type) override { return _to CallListenerVoid(type); } \
  NS_IMETHOD UpdateReadyState(const nsAString & readyState) override { return _to UpdateReadyState(readyState); } \
  ...
  NS_IMETHOD CreateAcceptedParent(nsISocketTransport *transport, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override { return _to CreateAcceptedParent(transport, binaryType, window, _retval); } \
  NS_IMETHOD CreateAcceptedChild(nsITCPSocketChild *socketChild, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override { return _to CreateAcceptedChild(socketChild, binaryType, window, _retval); } \
  NS_IMETHOD SetAppId(uint32_t appId) override { return _to SetAppId(appId); } \
  NS_IMETHOD SetInBrowser(bool inBrowser) override { return _to SetInBrowser(inBrowser); } \
  NS_IMETHOD SetOnUpdateBufferedAmountHandler(JS::HandleValue handler) override { return _to SetOnUpdateBufferedAmountHandler(handler); } \
  NS_IMETHOD OnRecvSendFromChild(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, uint32_t trackingNumber) override { return _to OnRecvSendFromChild(data, byteOffset, byteLength, trackingNumber); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITCPSOCKETINTERNAL(_to) \
  NS_IMETHOD CallListenerError(const nsAString & type, const nsAString & name) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CallListenerError(type, name); } \
  NS_IMETHOD CallListenerData(const nsAString & type, const nsAString & data) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CallListenerData(type, data); } \
  NS_IMETHOD CallListenerArrayBuffer(const nsAString & type, JS::HandleValue data) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CallListenerArrayBuffer(type, data); } \
  NS_IMETHOD CallListenerVoid(const nsAString & type) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CallListenerVoid(type); } \
  NS_IMETHOD UpdateReadyState(const nsAString & readyState) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateReadyState(readyState); } \
  ...
  NS_IMETHOD CreateAcceptedParent(nsISocketTransport *transport, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateAcceptedParent(transport, binaryType, window, _retval); } \
  NS_IMETHOD CreateAcceptedChild(nsITCPSocketChild *socketChild, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateAcceptedChild(socketChild, binaryType, window, _retval); } \
  NS_IMETHOD SetAppId(uint32_t appId) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAppId(appId); } \
  NS_IMETHOD SetInBrowser(bool inBrowser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInBrowser(inBrowser); } \
  NS_IMETHOD SetOnUpdateBufferedAmountHandler(JS::HandleValue handler) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnUpdateBufferedAmountHandler(handler); } \
  NS_IMETHOD OnRecvSendFromChild(JS::HandleValue data, uint32_t byteOffset, uint32_t byteLength, uint32_t trackingNumber) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRecvSendFromChild(data, byteOffset, byteLength, trackingNumber); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTCPSocketInternal, nsITCPSocketInternal)
...
/* nsIDOMTCPSocket createAcceptedParent (in nsISocketTransport transport, in DOMString binaryType, in nsIDOMWindow window); */
NS_IMETHODIMP nsTCPSocketInternal::CreateAcceptedParent(nsISocketTransport *transport, const nsAString & binaryType, nsIDOMWindow *window, nsIDOMTCPSocket * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void setInBrowser (in boolean inBrowser); */
NS_IMETHODIMP nsTCPSocketInternal::SetInBrowser(bool inBrowser)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NSITCPSOCKETEVENT \
  NS_IMETHOD GetTarget(nsIDOMTCPSocket * *aTarget) override; \
  NS_IMETHOD GetType(nsAString & aType) override; \
  NS_IMETHOD GetData(JS::MutableHandleValue aData) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITCPSOCKETEVENT(_to) \
  NS_IMETHOD GetTarget(nsIDOMTCPSocket * *aTarget) override { return _to GetTarget(aTarget); } \
  NS_IMETHOD GetType(nsAString & aType) override { return _to GetType(aType); } \
  NS_IMETHOD GetData(JS::MutableHandleValue aData) override { return _to GetData(aData); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITCPSOCKETEVENT(_to) \
  NS_IMETHOD GetTarget(nsIDOMTCPSocket * *aTarget) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTarget(aTarget); } \
  NS_IMETHOD GetType(nsAString & aType) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetType(aType); } \
  NS_IMETHOD GetData(JS::MutableHandleValue aData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetData(aData); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTCPSocketEvent, nsITCPSocketEvent)
