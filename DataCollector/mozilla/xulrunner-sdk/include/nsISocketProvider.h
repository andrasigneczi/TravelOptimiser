...
#define NS_DECL_NSISOCKETPROVIDER \
  NS_IMETHOD NewSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc **aFileDesc, nsISupports * *aSecurityInfo) override; \
  NS_IMETHOD AddToSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc *aFileDesc, nsISupports * *aSecurityInfo) override; \

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISOCKETPROVIDER(_to) \
  NS_IMETHOD NewSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc **aFileDesc, nsISupports * *aSecurityInfo) override { return _to NewSocket(aFamily, aHost, aPort, aProxyHost, aProxyPort, aFlags, aFileDesc, aSecurityInfo); } \
  NS_IMETHOD AddToSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc *aFileDesc, nsISupports * *aSecurityInfo) override { return _to AddToSocket(aFamily, aHost, aPort, aProxyHost, aProxyPort, aFlags, aFileDesc, aSecurityInfo); } \

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISOCKETPROVIDER(_to) \
  NS_IMETHOD NewSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc **aFileDesc, nsISupports * *aSecurityInfo) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NewSocket(aFamily, aHost, aPort, aProxyHost, aProxyPort, aFlags, aFileDesc, aSecurityInfo); } \
  NS_IMETHOD AddToSocket(int32_t aFamily, const char * aHost, int32_t aPort, const char * aProxyHost, int32_t aProxyPort, uint32_t aFlags, struct PRFileDesc *aFileDesc, nsISupports * *aSecurityInfo) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddToSocket(aFamily, aHost, aPort, aProxyHost, aProxyPort, aFlags, aFileDesc, aSecurityInfo); } \
