...
#define NS_DECL_NSIUSAGECALLBACK \
  NS_IMETHOD OnUsageResult(nsIURI *aURI, uint64_t aUsage, uint64_t aFileUsage, uint32_t aAppId, bool aInMozBrowserOnly) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUSAGECALLBACK(_to) \
  NS_IMETHOD OnUsageResult(nsIURI *aURI, uint64_t aUsage, uint64_t aFileUsage, uint32_t aAppId, bool aInMozBrowserOnly) override { return _to OnUsageResult(aURI, aUsage, aFileUsage, aAppId, aInMozBrowserOnly); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUSAGECALLBACK(_to) \
  NS_IMETHOD OnUsageResult(nsIURI *aURI, uint64_t aUsage, uint64_t aFileUsage, uint32_t aAppId, bool aInMozBrowserOnly) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnUsageResult(aURI, aUsage, aFileUsage, aAppId, aInMozBrowserOnly); } 
