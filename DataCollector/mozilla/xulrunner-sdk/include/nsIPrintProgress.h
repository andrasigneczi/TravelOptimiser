...
#define NS_DECL_NSIPRINTPROGRESS \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen) override; \
...
#define NS_FORWARD_NSIPRINTPROGRESS(_to) \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen) override { return _to OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
...
#define NS_FORWARD_SAFE_NSIPRINTPROGRESS(_to) \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
