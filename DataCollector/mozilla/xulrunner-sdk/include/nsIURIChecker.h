...
#define NS_DECL_NSIURICHECKER \
  ...
  NS_IMETHOD AsyncCheck(nsIRequestObserver *aObserver, nsISupports *aContext) override; 
...
#define NS_FORWARD_NSIURICHECKER(_to) \
  ...
  NS_IMETHOD AsyncCheck(nsIRequestObserver *aObserver, nsISupports *aContext) override { return _to AsyncCheck(aObserver, aContext); } 
...
#define NS_FORWARD_SAFE_NSIURICHECKER(_to) \
  ...
  NS_IMETHOD AsyncCheck(nsIRequestObserver *aObserver, nsISupports *aContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AsyncCheck(aObserver, aContext); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsURIChecker, nsIURIChecker)
