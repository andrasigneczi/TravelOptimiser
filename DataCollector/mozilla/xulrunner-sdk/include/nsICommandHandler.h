...
#define NS_DECL_NSICOMMANDHANDLERINIT \
  ...
  NS_IMETHOD SetWindow(nsIDOMWindow *aWindow) override; 
...
#define NS_FORWARD_NSICOMMANDHANDLERINIT(_to) \
  ...
  NS_IMETHOD SetWindow(nsIDOMWindow *aWindow) override { return _to SetWindow(aWindow); } 
...
#define NS_FORWARD_SAFE_NSICOMMANDHANDLERINIT(_to) \
  ...
  NS_IMETHOD SetWindow(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWindow(aWindow); } 
