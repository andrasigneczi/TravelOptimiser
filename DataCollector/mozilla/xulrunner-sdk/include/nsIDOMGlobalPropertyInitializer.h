...
#define NS_DECL_NSIDOMGLOBALPROPERTYINITIALIZER \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::MutableHandleValue _retval) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::MutableHandleValue _retval) override { return _to Init(window, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::MutableHandleValue _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(window, _retval); } 
