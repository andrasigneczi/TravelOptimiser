...
#define NS_DECL_NSIPKCS11MODULE \
  ...
  NS_IMETHOD ListSlots(nsIEnumerator * *_retval) override; 
...
#define NS_FORWARD_NSIPKCS11MODULE(_to) \
  ...
  NS_IMETHOD ListSlots(nsIEnumerator * *_retval) override { return _to ListSlots(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULE(_to) \
  ...
  NS_IMETHOD ListSlots(nsIEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ListSlots(_retval); } 
