...
#define NS_DECL_NSIPROMPTSERVICE2 \
  NS_IMETHOD PromptAuth(nsIDOMWindow *aParent, nsIChannel *aChannel, uint32_t level, nsIAuthInformation *authInfo, const char16_t * checkboxLabel, bool *checkValue, bool *_retval) override; \
  NS_IMETHOD AsyncPromptAuth(nsIDOMWindow *aParent, nsIChannel *aChannel, nsIAuthPromptCallback *aCallback, nsISupports *aContext, uint32_t level, nsIAuthInformation *authInfo, const char16_t * checkboxLabel, bool *checkValue, nsICancelable * *_retval) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROMPTSERVICE2(_to) \
  NS_IMETHOD PromptAuth(nsIDOMWindow *aParent, nsIChannel *aChannel, uint32_t level, nsIAuthInformation *authInfo, const char16_t * checkboxLabel, bool *checkValue, bool *_retval) override { return _to PromptAuth(aParent, aChannel, level, authInfo, checkboxLabel, checkValue, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPROMPTSERVICE2(_to) \
  NS_IMETHOD PromptAuth(nsIDOMWindow *aParent, nsIChannel *aChannel, uint32_t level, nsIAuthInformation *authInfo, const char16_t * checkboxLabel, bool *checkValue, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PromptAuth(aParent, aChannel, level, authInfo, checkboxLabel, checkValue, _retval); } \
