...
#define NS_DECL_NSICOMMANDMANAGER \
  ...
  NS_IMETHOD IsCommandSupported(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override; \
  NS_IMETHOD IsCommandEnabled(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override; \
  NS_IMETHOD GetCommandState(const char * aCommandName, nsIDOMWindow *aTargetWindow, nsICommandParams *aCommandParams) override; \
  NS_IMETHOD DoCommand(const char * aCommandName, nsICommandParams *aCommandParams, nsIDOMWindow *aTargetWindow) override; 
...
#define NS_FORWARD_NSICOMMANDMANAGER(_to) \
  ...
  NS_IMETHOD IsCommandSupported(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override { return _to IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD IsCommandEnabled(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override { return _to IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD GetCommandState(const char * aCommandName, nsIDOMWindow *aTargetWindow, nsICommandParams *aCommandParams) override { return _to GetCommandState(aCommandName, aTargetWindow, aCommandParams); } \
  NS_IMETHOD DoCommand(const char * aCommandName, nsICommandParams *aCommandParams, nsIDOMWindow *aTargetWindow) override { return _to DoCommand(aCommandName, aCommandParams, aTargetWindow); } 
...
#define NS_FORWARD_SAFE_NSICOMMANDMANAGER(_to) \
  ...
  NS_IMETHOD IsCommandSupported(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD IsCommandEnabled(const char * aCommandName, nsIDOMWindow *aTargetWindow, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD GetCommandState(const char * aCommandName, nsIDOMWindow *aTargetWindow, nsICommandParams *aCommandParams) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCommandState(aCommandName, aTargetWindow, aCommandParams); } \
  NS_IMETHOD DoCommand(const char * aCommandName, nsICommandParams *aCommandParams, nsIDOMWindow *aTargetWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DoCommand(aCommandName, aCommandParams, aTargetWindow); } 
