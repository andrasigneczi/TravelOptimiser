...
#define NS_DECL_NSIWEBVTTPARSERWRAPPER \
  NS_IMETHOD LoadParser(nsIDOMWindow *window) override; \
  ...
  NS_IMETHOD ConvertCueToDOMTree(nsIDOMWindow *window, nsISupports *cue, nsIDOMHTMLElement * *_retval) override; \
  NS_IMETHOD ProcessCues(nsIDOMWindow *window, nsIVariant *cues, nsISupports *overlay) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBVTTPARSERWRAPPER(_to) \
  NS_IMETHOD LoadParser(nsIDOMWindow *window) override { return _to LoadParser(window); } \
  ...
  NS_IMETHOD ConvertCueToDOMTree(nsIDOMWindow *window, nsISupports *cue, nsIDOMHTMLElement * *_retval) override { return _to ConvertCueToDOMTree(window, cue, _retval); } \
  NS_IMETHOD ProcessCues(nsIDOMWindow *window, nsIVariant *cues, nsISupports *overlay) override { return _to ProcessCues(window, cues, overlay); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBVTTPARSERWRAPPER(_to) \
  NS_IMETHOD LoadParser(nsIDOMWindow *window) override { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadParser(window); } \
  ...
  NS_IMETHOD ConvertCueToDOMTree(nsIDOMWindow *window, nsISupports *cue, nsIDOMHTMLElement * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertCueToDOMTree(window, cue, _retval); } \
  NS_IMETHOD ProcessCues(nsIDOMWindow *window, nsIVariant *cues, nsISupports *overlay) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ProcessCues(window, cues, overlay); } 
