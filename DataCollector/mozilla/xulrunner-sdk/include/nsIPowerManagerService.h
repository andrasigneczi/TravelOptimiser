...
#define NS_DECL_NSIPOWERMANAGERSERVICE \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsISupports * *_retval) override; 
...
#define NS_FORWARD_NSIPOWERMANAGERSERVICE(_to) \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsISupports * *_retval) override { return _to NewWakeLock(aTopic, aWindow, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPOWERMANAGERSERVICE(_to) \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsISupports * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NewWakeLock(aTopic, aWindow, _retval); } 
