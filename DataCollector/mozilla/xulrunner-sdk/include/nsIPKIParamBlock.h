...
#define NS_DECL_NSIPKIPARAMBLOCK \
  NS_IMETHOD SetISupportAtIndex(int32_t index, nsISupports *object) override; \
  NS_IMETHOD GetISupportAtIndex(int32_t index, nsISupports * *_retval) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPKIPARAMBLOCK(_to) \
  NS_IMETHOD SetISupportAtIndex(int32_t index, nsISupports *object) override { return _to SetISupportAtIndex(index, object); } \
  NS_IMETHOD GetISupportAtIndex(int32_t index, nsISupports * *_retval) override { return _to GetISupportAtIndex(index, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPKIPARAMBLOCK(_to) \
  NS_IMETHOD SetISupportAtIndex(int32_t index, nsISupports *object) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetISupportAtIndex(index, object); } \
  NS_IMETHOD GetISupportAtIndex(int32_t index, nsISupports * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetISupportAtIndex(index, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsPKIParamBlock, nsIPKIParamBlock)
