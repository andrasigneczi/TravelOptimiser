...
#define NS_DECL_NSICOOKIEMANAGER \
  ...
  NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) override; 
...
#define NS_FORWARD_NSICOOKIEMANAGER(_to) \
  ...
  NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) override { return _to Remove(aHost, aName, aPath, aBlocked); } 
...
#define NS_FORWARD_SAFE_NSICOOKIEMANAGER(_to) \
  ...
  NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(aHost, aName, aPath, aBlocked); } 
