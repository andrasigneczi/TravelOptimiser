...
#define NS_DECL_NSIWEBBROWSER \
  ...
  NS_IMETHOD GetContentDOMWindow(nsIDOMWindow * *aContentDOMWindow) override; \
...
#define NS_FORWARD_NSIWEBBROWSER(_to) \
  ...
  NS_IMETHOD GetContentDOMWindow(nsIDOMWindow * *aContentDOMWindow) override { return _to GetContentDOMWindow(aContentDOMWindow); } \
...
#define NS_FORWARD_SAFE_NSIWEBBROWSER(_to) \
  ...
  NS_IMETHOD GetContentDOMWindow(nsIDOMWindow * *aContentDOMWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContentDOMWindow(aContentDOMWindow); } \
