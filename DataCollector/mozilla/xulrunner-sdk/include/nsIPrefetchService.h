...
#define NS_DECL_NSIPREFETCHSERVICE \
  ...
  NS_IMETHOD EnumerateQueue(nsISimpleEnumerator * *_retval) override; 
...
#define NS_FORWARD_NSIPREFETCHSERVICE(_to) \
  ...
  NS_IMETHOD EnumerateQueue(nsISimpleEnumerator * *_retval) override { return _to EnumerateQueue(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPREFETCHSERVICE(_to) \
  ...
  NS_IMETHOD EnumerateQueue(nsISimpleEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateQueue(_retval); } 
