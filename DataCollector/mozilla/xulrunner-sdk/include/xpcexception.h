...
#define NS_DECL_NSIXPCEXCEPTION \
  NS_IMETHOD Initialize(const nsACString & aMessage, nsresult aResult, const nsACString & aName, nsIStackFrame *aLocation, nsISupports *aData, nsIException *aInner) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPCEXCEPTION(_to) \
  NS_IMETHOD Initialize(const nsACString & aMessage, nsresult aResult, const nsACString & aName, nsIStackFrame *aLocation, nsISupports *aData, nsIException *aInner) override { return _to Initialize(aMessage, aResult, aName, aLocation, aData, aInner); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPCEXCEPTION(_to) \
  NS_IMETHOD Initialize(const nsACString & aMessage, nsresult aResult, const nsACString & aName, nsIStackFrame *aLocation, nsISupports *aData, nsIException *aInner) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Initialize(aMessage, aResult, aName, aLocation, aData, aInner); } 
