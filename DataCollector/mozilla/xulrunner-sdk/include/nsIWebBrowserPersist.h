...
#define NS_IWEBBROWSERPERSIST_IID_STR "effe7374-5c7d-4b1e-a96f-27b283df189b"

#define NS_IWEBBROWSERPERSIST_IID \
  {0xeffe7374, 0x5c7d, 0x4b1e, \
    { 0xa9, 0x6f, 0x27, 0xb2, 0x83, 0xdf, 0x18, 0x9b }}
...
#define NS_DECL_NSIWEBBROWSERPERSIST \
  ...
  NS_IMETHOD SaveDocument(nsIDOMDocument *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn) override; \
...
#define NS_FORWARD_NSIWEBBROWSERPERSIST(_to) \
  ...
  NS_IMETHOD SaveDocument(nsIDOMDocument *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn) override { return _to SaveDocument(aDocument, aFile, aDataPath, aOutputContentType, aEncodingFlags, aWrapColumn); } \
...
#define NS_FORWARD_SAFE_NSIWEBBROWSERPERSIST(_to) \
  ...
  NS_IMETHOD SaveDocument(nsIDOMDocument *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SaveDocument(aDocument, aFile, aDataPath, aOutputContentType, aEncodingFlags, aWrapColumn); } \
