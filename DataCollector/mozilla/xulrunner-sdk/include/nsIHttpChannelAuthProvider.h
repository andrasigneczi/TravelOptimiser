...
#define NS_DECL_NSIHTTPCHANNELAUTHPROVIDER \
  ...
  NS_IMETHOD AddAuthorizationHeaders(void) override; \
...
#define NS_FORWARD_NSIHTTPCHANNELAUTHPROVIDER(_to) \
  ...
  NS_IMETHOD AddAuthorizationHeaders(void) override { return _to AddAuthorizationHeaders(); } \
...
#define NS_FORWARD_SAFE_NSIHTTPCHANNELAUTHPROVIDER(_to) \
  ...
  NS_IMETHOD AddAuthorizationHeaders(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddAuthorizationHeaders(); } \
