...
#define NS_DECL_NSICOLORPICKER \
  NS_IMETHOD Init(nsIDOMWindow *parent, const nsAString & title, const nsAString & initialColor) override; \
  NS_IMETHOD Open(nsIColorPickerShownCallback *aColorPickerShownCallback) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICOLORPICKER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *parent, const nsAString & title, const nsAString & initialColor) override { return _to Init(parent, title, initialColor); } \
...
#define NS_FORWARD_SAFE_NSICOLORPICKER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *parent, const nsAString & title, const nsAString & initialColor) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(parent, title, initialColor); } \
