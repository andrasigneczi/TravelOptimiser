...
#define NS_DECL_NSIDOMCOMPOSITIONEVENT \
  ...
  NS_IMETHOD GetLocale(nsAString & aLocale) override; \
  NS_IMETHOD InitCompositionEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, const nsAString & dataArg, const nsAString & localeArg) override; 
...
#define NS_FORWARD_NSIDOMCOMPOSITIONEVENT(_to) \
  ...
  NS_IMETHOD GetLocale(nsAString & aLocale) override { return _to GetLocale(aLocale); } \
  NS_IMETHOD InitCompositionEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, const nsAString & dataArg, const nsAString & localeArg) override { return _to InitCompositionEvent(typeArg, canBubbleArg, cancelableArg, viewArg, dataArg, localeArg); } 
...
#define NS_FORWARD_SAFE_NSIDOMCOMPOSITIONEVENT(_to) \
  ...
  NS_IMETHOD GetLocale(nsAString & aLocale) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocale(aLocale); } \
  NS_IMETHOD InitCompositionEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, const nsAString & dataArg, const nsAString & localeArg) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitCompositionEvent(typeArg, canBubbleArg, cancelableArg, viewArg, dataArg, localeArg); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMCompositionEvent, nsIDOMCompositionEvent)
