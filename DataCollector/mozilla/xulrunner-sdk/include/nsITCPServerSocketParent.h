...
#define NS_DECL_NSITCPSERVERSOCKETPARENT \
  NS_IMETHOD SendCallbackAccept(nsITCPSocketParent *socket) override; \
  NS_IMETHOD SendCallbackError(const nsAString & message, const nsAString & filename, uint32_t lineNumber, uint32_t columnNumber) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITCPSERVERSOCKETPARENT(_to) \
  NS_IMETHOD SendCallbackAccept(nsITCPSocketParent *socket) override { return _to SendCallbackAccept(socket); } \
  NS_IMETHOD SendCallbackError(const nsAString & message, const nsAString & filename, uint32_t lineNumber, uint32_t columnNumber) override { return _to SendCallbackError(message, filename, lineNumber, columnNumber); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITCPSERVERSOCKETPARENT(_to) \
  NS_IMETHOD SendCallbackAccept(nsITCPSocketParent *socket) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendCallbackAccept(socket); } \
  NS_IMETHOD SendCallbackError(const nsAString & message, const nsAString & filename, uint32_t lineNumber, uint32_t columnNumber) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendCallbackError(message, filename, lineNumber, columnNumber); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTCPServerSocketParent, nsITCPServerSocketParent)
