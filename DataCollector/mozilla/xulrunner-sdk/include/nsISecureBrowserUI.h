...
#define NS_DECL_NSISECUREBROWSERUI \
  NS_IMETHOD Init(nsIDOMWindow *window) override; \
...
#define NS_FORWARD_NSISECUREBROWSERUI(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window) override { return _to Init(window); } \
...
#define NS_FORWARD_SAFE_NSISECUREBROWSERUI(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(window); } \
