...
#define NS_DECL_NSIDOMXULCOMMANDEVENT \
  ...
  NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, int32_t detailArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, nsIDOMEvent *sourceEvent) override; 
...
#define NS_FORWARD_NSIDOMXULCOMMANDEVENT(_to) \
  ...
  NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, int32_t detailArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, nsIDOMEvent *sourceEvent) override { return _to InitCommandEvent(typeArg, canBubbleArg, cancelableArg, viewArg, detailArg, ctrlKeyArg, altKeyArg, shiftKeyArg, metaKeyArg, sourceEvent); } 
...
#define NS_FORWARD_SAFE_NSIDOMXULCOMMANDEVENT(_to) \
  ...
  NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMWindow *viewArg, int32_t detailArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, nsIDOMEvent *sourceEvent) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitCommandEvent(typeArg, canBubbleArg, cancelableArg, viewArg, detailArg, ctrlKeyArg, altKeyArg, shiftKeyArg, metaKeyArg, sourceEvent); } 
