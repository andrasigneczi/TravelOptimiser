...
#define NS_DECL_NSIWINDOWWATCHER \
  NS_IMETHOD OpenWindow(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, nsISupports *aArguments, nsIDOMWindow * *_retval) override; \
  ...
  NS_IMETHOD GetNewPrompter(nsIDOMWindow *aParent, nsIPrompt * *_retval) override; \
  NS_IMETHOD GetNewAuthPrompter(nsIDOMWindow *aParent, nsIAuthPrompt * *_retval) override; \
  NS_IMETHOD SetWindowCreator(nsIWindowCreator *creator) override; \
  NS_IMETHOD HasWindowCreator(bool *_retval) override; \
  NS_IMETHOD GetChromeForWindow(nsIDOMWindow *aWindow, nsIWebBrowserChrome * *_retval) override; \
  NS_IMETHOD GetWindowByName(const char16_t * aTargetName, nsIDOMWindow *aCurrentWindow, nsIDOMWindow * *_retval) override; \
...
#define NS_FORWARD_NSIWINDOWWATCHER(_to) \
  NS_IMETHOD OpenWindow(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, nsISupports *aArguments, nsIDOMWindow * *_retval) override { return _to OpenWindow(aParent, aUrl, aName, aFeatures, aArguments, _retval); } \
  ...
  NS_IMETHOD GetNewPrompter(nsIDOMWindow *aParent, nsIPrompt * *_retval) override { return _to GetNewPrompter(aParent, _retval); } \
  NS_IMETHOD GetNewAuthPrompter(nsIDOMWindow *aParent, nsIAuthPrompt * *_retval) override { return _to GetNewAuthPrompter(aParent, _retval); } \
  ...
  NS_IMETHOD GetChromeForWindow(nsIDOMWindow *aWindow, nsIWebBrowserChrome * *_retval) override { return _to GetChromeForWindow(aWindow, _retval); } \
  NS_IMETHOD GetWindowByName(const char16_t * aTargetName, nsIDOMWindow *aCurrentWindow, nsIDOMWindow * *_retval) override { return _to GetWindowByName(aTargetName, aCurrentWindow, _retval); } \
...
#define NS_FORWARD_SAFE_NSIWINDOWWATCHER(_to) \
  NS_IMETHOD OpenWindow(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, nsISupports *aArguments, nsIDOMWindow * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenWindow(aParent, aUrl, aName, aFeatures, aArguments, _retval); } \
  ...
  NS_IMETHOD GetNewPrompter(nsIDOMWindow *aParent, nsIPrompt * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNewPrompter(aParent, _retval); } \
  NS_IMETHOD GetNewAuthPrompter(nsIDOMWindow *aParent, nsIAuthPrompt * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNewAuthPrompter(aParent, _retval); } \
  ...
  NS_IMETHOD GetChromeForWindow(nsIDOMWindow *aWindow, nsIWebBrowserChrome * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChromeForWindow(aWindow, _retval); } \
  NS_IMETHOD GetWindowByName(const char16_t * aTargetName, nsIDOMWindow *aCurrentWindow, nsIDOMWindow * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWindowByName(aTargetName, aCurrentWindow, _retval); } \
