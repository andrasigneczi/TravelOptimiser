...
#define NS_DECL_NSIEDITORSPELLCHECK \
  NS_IMETHOD CheckCurrentDictionary(void) override; \
...
#define NS_FORWARD_NSIEDITORSPELLCHECK(_to) \
  NS_IMETHOD CheckCurrentDictionary(void) override { return _to CheckCurrentDictionary(); } \
...
#define NS_FORWARD_SAFE_NSIEDITORSPELLCHECK(_to) \
  NS_IMETHOD CheckCurrentDictionary(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckCurrentDictionary(); } \
