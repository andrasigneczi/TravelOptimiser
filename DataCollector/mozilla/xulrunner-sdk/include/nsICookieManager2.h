...
#define NS_DECL_NSICOOKIEMANAGER2 \
  ...
  NS_IMETHOD GetCookiesForApp(uint32_t appId, bool onlyBrowserElement, nsISimpleEnumerator * *_retval) override; \
  NS_IMETHOD RemoveCookiesForApp(uint32_t appId, bool onlyBrowserElement) override; 
...
#define NS_FORWARD_NSICOOKIEMANAGER2(_to) \
  ...
  NS_IMETHOD GetCookiesForApp(uint32_t appId, bool onlyBrowserElement, nsISimpleEnumerator * *_retval) override { return _to GetCookiesForApp(appId, onlyBrowserElement, _retval); } \
  NS_IMETHOD RemoveCookiesForApp(uint32_t appId, bool onlyBrowserElement) override { return _to RemoveCookiesForApp(appId, onlyBrowserElement); } 
...
#define NS_FORWARD_SAFE_NSICOOKIEMANAGER2(_to) \
  ...
  NS_IMETHOD GetCookiesForApp(uint32_t appId, bool onlyBrowserElement, nsISimpleEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCookiesForApp(appId, onlyBrowserElement, _retval); } \
  NS_IMETHOD RemoveCookiesForApp(uint32_t appId, bool onlyBrowserElement) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveCookiesForApp(appId, onlyBrowserElement); } 
