...
#define NS_DECL_NSIDOMTIMEEVENT \
  ...
  NS_IMETHOD InitTimeEvent(const nsAString & typeArg, nsIDOMWindow *viewArg, int32_t detailArg) override; 
...
#define NS_FORWARD_NSIDOMTIMEEVENT(_to) \
  ...
  NS_IMETHOD InitTimeEvent(const nsAString & typeArg, nsIDOMWindow *viewArg, int32_t detailArg) override { return _to InitTimeEvent(typeArg, viewArg, detailArg); } 
...
#define NS_FORWARD_SAFE_NSIDOMTIMEEVENT(_to) \
  ...
  NS_IMETHOD InitTimeEvent(const nsAString & typeArg, nsIDOMWindow *viewArg, int32_t detailArg) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitTimeEvent(typeArg, viewArg, detailArg); } 
