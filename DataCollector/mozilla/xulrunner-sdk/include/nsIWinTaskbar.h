...
#define NS_DECL_NSIWINTASKBAR \
  ...
  NS_IMETHOD SetGroupIdForWindow(nsIDOMWindow *aParent, const nsAString & aIdentifier) override; \
  NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) override; \
...
#define NS_FORWARD_NSIWINTASKBAR(_to) \
  ...
  NS_IMETHOD SetGroupIdForWindow(nsIDOMWindow *aParent, const nsAString & aIdentifier) override { return _to SetGroupIdForWindow(aParent, aIdentifier); } \
  NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) override { return _to PrepareFullScreen(aWindow, aFullScreen); } \
...
#define NS_FORWARD_SAFE_NSIWINTASKBAR(_to) \
  ...
  NS_IMETHOD SetGroupIdForWindow(nsIDOMWindow *aParent, const nsAString & aIdentifier) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetGroupIdForWindow(aParent, aIdentifier); } \
  NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PrepareFullScreen(aWindow, aFullScreen); } \
