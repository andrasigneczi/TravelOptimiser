...
void
ImplCycleCollectionTraverse(nsCycleCollectionTraversalCallback& aCallback, OwningHTMLImageElementOrHTMLCanvasElementOrHTMLVideoElement& aUnion, const char* aName, uint32_t aFlags = 0);
...
void
ImplCycleCollectionUnlink(OwningHTMLImageElementOrHTMLCanvasElementOrHTMLVideoElement& aUnion);
...
{
  friend void ImplCycleCollectionUnlink(OwningHTMLImageElementOrHTMLCanvasElementOrHTMLVideoElement& aUnion);
  enum Type
  {
    eUninitialized,
    eHTMLImageElement,
...
struct HitRegionOptions : public DictionaryBase
{
  ...
  nsString mId;
  nsRefPtr<mozilla::dom::CanvasPath> mPath;
