...
#ifndef mozilla_dom_TrackEvent_h
#define mozilla_dom_TrackEvent_h
...
protected:
  virtual ~TrackEvent();
  explicit TrackEvent(mozilla::dom::EventTarget* aOwner);

  Nullable<OwningVideoTrackOrAudioTrackOrTextTrack> mTrack;

public:
  virtual TrackEvent* AsTrackEvent() override;
  ...
  void GetTrack(Nullable<OwningVideoTrackOrAudioTrackOrTextTrack>& aRetVal) const;
};

} // namespace dom
} // namespace mozilla

#endif // mozilla_dom_TrackEvent_h
