...
namespace IDBDatabaseBinding {
  ...
  bool
  Wrap(JSContext* aCx, mozilla::dom::indexedDB::IDBDatabase* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
