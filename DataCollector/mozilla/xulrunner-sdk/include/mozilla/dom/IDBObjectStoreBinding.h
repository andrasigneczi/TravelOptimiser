...
namespace IDBObjectStoreBinding {
  ...
  bool
  Wrap(JSContext* aCx, mozilla::dom::indexedDB::IDBObjectStore* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
