...
namespace IDBFileHandleBinding {
  ...
  bool
  Wrap(JSContext* aCx, mozilla::dom::indexedDB::IDBFileHandle* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
