...
#define NS_DECL_NSIFRAMEREQUESTCALLBACK \
  NS_IMETHOD Sample(DOMTimeStamp timeStamp) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFRAMEREQUESTCALLBACK(_to) \
  NS_IMETHOD Sample(DOMTimeStamp timeStamp) override { return _to Sample(timeStamp); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFRAMEREQUESTCALLBACK(_to) \
  NS_IMETHOD Sample(DOMTimeStamp timeStamp) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Sample(timeStamp); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFrameRequestCallback, nsIFrameRequestCallback)
