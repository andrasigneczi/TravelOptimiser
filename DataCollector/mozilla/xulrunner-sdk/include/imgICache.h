...
#define NS_DECL_IMGICACHE \
  ...
  NS_IMETHOD RemoveEntry(nsIURI *uri) override; \
  NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties * *_retval) override; \
...
#define NS_FORWARD_IMGICACHE(_to) \
  ...
  NS_IMETHOD RemoveEntry(nsIURI *uri) override { return _to RemoveEntry(uri); } \
  NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties * *_retval) override { return _to FindEntryProperties(uri, _retval); } \
...
#define NS_FORWARD_SAFE_IMGICACHE(_to) \
  ...
  NS_IMETHOD RemoveEntry(nsIURI *uri) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveEntry(uri); } \
  NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindEntryProperties(uri, _retval); } \
