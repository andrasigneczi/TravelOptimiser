...
#define NS_DECL_NSIPK11TOKENDB \
  ...
  NS_IMETHOD ListTokens(nsIEnumerator * *_retval) override; 
...
#define NS_FORWARD_NSIPK11TOKENDB(_to) \
  ...
  NS_IMETHOD ListTokens(nsIEnumerator * *_retval) override { return _to ListTokens(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPK11TOKENDB(_to) \
  ...
  NS_IMETHOD ListTokens(nsIEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ListTokens(_retval); } 
