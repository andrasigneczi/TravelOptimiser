...
#define NS_DECL_NSIFORMSUBMITOBSERVER \
  NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, bool *cancelSubmit) override; \
...
#define NS_FORWARD_NSIFORMSUBMITOBSERVER(_to) \
  NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, bool *cancelSubmit) override { return _to Notify(formNode, window, actionURL, cancelSubmit); } \
...
#define NS_FORWARD_SAFE_NSIFORMSUBMITOBSERVER(_to) \
  NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, bool *cancelSubmit) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Notify(formNode, window, actionURL, cancelSubmit); } \
