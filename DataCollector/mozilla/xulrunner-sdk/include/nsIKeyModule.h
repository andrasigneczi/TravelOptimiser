...
#define NS_DECL_NSIKEYOBJECT \
  NS_IMETHOD InitKey(int16_t aAlgorithm, void *aKey) override; \
  NS_IMETHOD GetKeyObj(void **_retval) override; \
  NS_IMETHOD GetType(int16_t *_retval) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIKEYOBJECT(_to) \
  NS_IMETHOD InitKey(int16_t aAlgorithm, void *aKey) override { return _to InitKey(aAlgorithm, aKey); } \
  NS_IMETHOD GetKeyObj(void **_retval) override { return _to GetKeyObj(_retval); } \
...
#define NS_FORWARD_SAFE_NSIKEYOBJECT(_to) \
  NS_IMETHOD InitKey(int16_t aAlgorithm, void *aKey) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitKey(aAlgorithm, aKey); } \
  NS_IMETHOD GetKeyObj(void **_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyObj(_retval); } \
...
#define NS_DECL_NSIKEYOBJECTFACTORY \
  NS_IMETHOD LookupKeyByName(const nsACString & aName, nsIKeyObject * *_retval) override; \
  NS_IMETHOD UnwrapKey(int16_t aAlgorithm, const uint8_t *aWrappedKey, uint32_t aWrappedKeyLen, nsIKeyObject * *_retval) override; \
...
#define NS_FORWARD_NSIKEYOBJECTFACTORY(_to) \
  NS_IMETHOD LookupKeyByName(const nsACString & aName, nsIKeyObject * *_retval) override { return _to LookupKeyByName(aName, _retval); } \
  NS_IMETHOD UnwrapKey(int16_t aAlgorithm, const uint8_t *aWrappedKey, uint32_t aWrappedKeyLen, nsIKeyObject * *_retval) override { return _to UnwrapKey(aAlgorithm, aWrappedKey, aWrappedKeyLen, _retval); } \
...
#define NS_FORWARD_SAFE_NSIKEYOBJECTFACTORY(_to) \
  NS_IMETHOD LookupKeyByName(const nsACString & aName, nsIKeyObject * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->LookupKeyByName(aName, _retval); } \
  NS_IMETHOD UnwrapKey(int16_t aAlgorithm, const uint8_t *aWrappedKey, uint32_t aWrappedKeyLen, nsIKeyObject * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UnwrapKey(aAlgorithm, aWrappedKey, aWrappedKeyLen, _retval); } \
