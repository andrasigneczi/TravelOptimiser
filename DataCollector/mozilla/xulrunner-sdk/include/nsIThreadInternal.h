...
#define NS_DECL_NSITHREADINTERNAL \
  ...
  NS_IMETHOD GetRecursionDepth(uint32_t *aRecursionDepth) override; \
...
#define NS_FORWARD_NSITHREADINTERNAL(_to) \
  ...
  NS_IMETHOD GetRecursionDepth(uint32_t *aRecursionDepth) override { return _to GetRecursionDepth(aRecursionDepth); } \
...
#define NS_FORWARD_SAFE_NSITHREADINTERNAL(_to) \
  ...
  NS_IMETHOD GetRecursionDepth(uint32_t *aRecursionDepth) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRecursionDepth(aRecursionDepth); } \
...
#define NS_DECL_NSITHREADOBSERVER \
  ...
  NS_IMETHOD OnProcessNextEvent(nsIThreadInternal *thread, bool mayWait, uint32_t recursionDepth) override; \
  NS_IMETHOD AfterProcessNextEvent(nsIThreadInternal *thread, uint32_t recursionDepth, bool eventWasProcessed) override; 
...
#define NS_FORWARD_NSITHREADOBSERVER(_to) \
  ...
  NS_IMETHOD OnProcessNextEvent(nsIThreadInternal *thread, bool mayWait, uint32_t recursionDepth) override { return _to OnProcessNextEvent(thread, mayWait, recursionDepth); } \
  NS_IMETHOD AfterProcessNextEvent(nsIThreadInternal *thread, uint32_t recursionDepth, bool eventWasProcessed) override { return _to AfterProcessNextEvent(thread, recursionDepth, eventWasProcessed); } 
...
#define NS_FORWARD_SAFE_NSITHREADOBSERVER(_to) \
  ...
  NS_IMETHOD OnProcessNextEvent(nsIThreadInternal *thread, bool mayWait, uint32_t recursionDepth) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnProcessNextEvent(thread, mayWait, recursionDepth); } \
  NS_IMETHOD AfterProcessNextEvent(nsIThreadInternal *thread, uint32_t recursionDepth, bool eventWasProcessed) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AfterProcessNextEvent(thread, recursionDepth, eventWasProcessed); } 
