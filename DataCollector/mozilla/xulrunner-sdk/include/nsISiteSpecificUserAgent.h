...
#define NS_DECL_NSISITESPECIFICUSERAGENT \
  NS_IMETHOD GetUserAgentForURIAndWindow(nsIURI *aURI, nsIDOMWindow *aWindow, nsAString & _retval) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISITESPECIFICUSERAGENT(_to) \
  NS_IMETHOD GetUserAgentForURIAndWindow(nsIURI *aURI, nsIDOMWindow *aWindow, nsAString & _retval) override { return _to GetUserAgentForURIAndWindow(aURI, aWindow, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISITESPECIFICUSERAGENT(_to) \
  NS_IMETHOD GetUserAgentForURIAndWindow(nsIURI *aURI, nsIDOMWindow *aWindow, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUserAgentForURIAndWindow(aURI, aWindow, _retval); } 
