...
#define NS_DECL_NSIPROMPTFACTORY \
  NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void **result) override; 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROMPTFACTORY(_to) \
  NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void **result) override { return _to GetPrompt(aParent, iid, result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROMPTFACTORY(_to) \
  NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void **result) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrompt(aParent, iid, result); } 
